...
public class ScoreVO_T {
	...
	/*
	 * 필드생성자 정의
	 * 객체를 생성할 때 변수 값을 지정하면서 만들 때
	 * 	ScoreVO scoreVO = new ScoreVO(학번, 국어점수, 영어점수, 수학점수, 음악점수, 역사점수);
	 * 이 때 호출되는 method
	 */
	public ScoreVO_T(String stNum, int kor, int eng, int math, int music, int history) {
		super();
		this.stNum = stNum;
		this.kor = kor;
		this.eng = eng;
	...
	/*
	 * Object 클래스로 부터 상속받은 
	 * 		toString() method를 재정의
	 * 
	 * VO 객체에 데이터를 저장한 후
	 * 잘 저장되었는지 확인하기 위한 Debuging용 method 재 정의
	 * 
	 */
