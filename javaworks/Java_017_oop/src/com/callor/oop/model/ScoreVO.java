 ...
 * 직접 접근할 수 없다.
 * 		ScoreVO sVO = newScoreVO();
 * 		sVO.strName = "홍길동"; // 이런 코드는 사용불가
...
public class ScoreVO {
	...
	/*
	 * 국어점수(intKor)를 저장할 인스턴스변수를
	 * private으로 선언하여 직접 접근할 수 없도록 만든다.
	 * 
	 * 국어점수(intKor) 인스턴스변수에
	...
	/*
	 * VO 클래스를 설계하면서
	 * intEng 인스턴스변수를 private으로 설정하여
	 * 변수에 직접 접근하지 못하도록 하고
	 * 
	 * 변수에 값을 저장할 때는 setIntEng() method를 통해서"만"
	 * 값을 저장하도록 설정한다
	 * 
	 ...
	 * intEng 변수의 값을 읽기 위해서 getIntEng() method를
	 * 또 하나 선언해둔다
	 * 
	 */
