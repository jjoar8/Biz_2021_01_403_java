...
import com.callor.opp.service.impl.CartServiceV1;
import com.callor.opp.service.impl.CartServiceV2;
...
public class CartEx_01 {
	...
	public static void main(String[] args) {
		...
		// 2. CartServiceV2 사용
		//	CartV1을 사용하다가 CartV2로 업그레이드 하면
		//	method를 호추랗느 ㄴ부분에서
		//	상당히 많은 코드 변경이 수행되어야 한다
		//	업그레이드를 위해 많은 코드 변경이 이루어지면
		//	그 과정에서 오류가 발행할 확률이 매우 높아진다
