...
public class CartServiceImplV2 implements CartService{
	...
	/*
	 * 1. cartList와 scan 인스턴스 객체변수를 선언 "만"
	 * 	생성은 하지 않는다
	 * 
	 * 이렇게 하면 생성되지 않은 
	 ...
	 * 
	 */
	public CartServiceImplV2() { // ctrl + space > constructor

		// 선언"만" 된 인스턴스 객체변수를
		// 클래스 생성자 method 내에서 초기화 한다
	...
	@Override
	public void inputCart() { // 이름을 바꾸면 오류가 난다
