...
public class MenuServiceImplV3 implements MenuService{
	...
	private Scanner scan; // 스캐너를 인스턴스 변수로 만들고
	public MenuServiceImplV3() { // 생성자에서 스캐너를 초기화 시켰다
	 ...
	 * 	선택된 결과값을 호출한 곳에 return 해줘야 한다
	 * 
	 * 이렇게 설계를 변경하려면 method를
	 * 	void type이 아닌 int 나 String 등 다른 type으로 변경해야 한다
	 * 	클래스의 method를 변경하려면
	...
	public Integer menuItem = null; // 인스턴스변수
	...
	public void selectMenu() {
		...
		while (true) {
			...
			System.out.println("QUIT to 끝내기");
			System.out.println("-------------------------------");
			System.out.print("선택 >> ");
